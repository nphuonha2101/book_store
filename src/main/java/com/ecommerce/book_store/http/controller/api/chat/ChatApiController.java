...
public class ChatApiController {
    ...
    public ChatApiController(BookService bookService, GeminiService geminiService, JwtUtils jwtUtils, UserService userService) {
    ...
    @PostMapping("/send")
    public ResponseEntity<ApiResponse<String>> sendChat(
        ...
        try {
            ...
            if (authorizationHeader != null && !authorizationHeader.isEmpty()) {
                ...
                if (email != null) {
                    userId = userService.findByEmail(email).map(AbstractEntity::getId).orElse(null);
                }
            }
            ...
            String response = geminiService.generateResponse(message, chatType, userId);
