...
public class VoucherApiController {
    ...
    @PostMapping("/all")
    public ResponseEntity<ApiResponse<List<Voucher>>> getAllVouchers(@RequestBody VoucherGetRequestDto voucherGetRequestDto) {
        try {
            List<Voucher> vouchers = voucherService.getVoucherWithConditions(voucherGetRequestDto.getCategoryIds(), voucherGetRequestDto.getMinSpend());
    ...
    public ResponseEntity<ApiResponse<Long>> applyVoucher(@RequestBody VoucherApplyRequestDto voucherApplyRequestDto) {
        try {
            Voucher voucher = voucherService.findByCode(voucherApplyRequestDto.getCode());
