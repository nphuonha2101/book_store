...
public class UserServiceImpl extends IServiceImpl<UserRequestDto, UserResponseDto, User>
    ...
    @Autowired
    public UserServiceImpl(UserRepository userRepository, PasswordEncoder passwordEncoder, FirebaseStorageService firebaseStorageService, AddressService addressService, MailService mailService) {
